            ...
            body = (
                <div className="list-group-item">
                    ...
                    <div className="buttons">
                        <button className="edit-todo" type="submit" onClick={this.handleSave}>Save</button>
            ...
            body = (
                <div className="list-group-item">
                    ...
                    <button className="edit-todo">
                        <span className="glyphicon glyphicon-edit pull-right" onClick={this.onClickEdit} />
                    </button>
                    <button className="delete-todo">
                        <span className="glyphicon glyphicon-trash pull-right" onClick={this.onClickRemove} />
                    </button>
                </div>
            );
        }
